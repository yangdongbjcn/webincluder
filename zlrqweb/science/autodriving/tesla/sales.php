<?php 
	include('before.php');
?>
	<script type="text/javascript" src="<?php echo $g_yd__data ?>autodriving/tesla/sales.js"></script>
	<script type="text/javascript" src="<?php echo $g_yd__data ?>autodriving/tesla/sales_season.js"></script>
