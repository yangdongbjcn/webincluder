...
<!-- bootstrap CSS必须放在这里，否则IE8显示不正常 -->
<link rel='stylesheet' href='<?php echo $g_yd__resources ?>bootstrap/css/bootstrap-3.3.0.css'>

</head>

<body>

<script src='<?php echo $g_yd__resources ?>jquery/jquery-1.12.4.min.js'></script>

<script src='<?php echo $g_yd__resources ?>bootstrap/js/bootstrap-3.3.0.js'></script>

<!--[if lte IE 8]>
<script src='<?php echo $g_yd__resources ?>bootstrap/js/respond.min.js'></script>
<script src='<?php echo $g_yd__resources ?>bootstrap/js/html5shiv.min.js'></script>
<![endif]-->

<script src='<?php echo $g_yd__resources ?>echarts/echarts-4.2.1.min.js'></script>
...
<link href='<?php echo $g_yd__resources ?>datatables/css/jquery.dataTables.min.css' rel='stylesheet'>
<!-- <link href='<?php echo $g_yd__resources ?>datatables/css/jquery.dataTables.bootstrap.css' rel='stylesheet'> -->
<script src='<?php echo $g_yd__resources ?>datatables/js/jquery.dataTables.min.js'></script>
