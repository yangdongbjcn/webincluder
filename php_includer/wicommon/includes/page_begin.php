...
<head>
    ...
    <link rel='stylesheet' href='<?php echo $g_resc ?>bootstrap-5.3.0-alpha1-dist/css/bootstrap.min.css'>
...
<body>
    ...
    <script type='text/javascript' src='<?php echo $g_project ?>basepath.js'></script>

    <script src='<?php echo $g_incl ?>page_begin.js'></script>
